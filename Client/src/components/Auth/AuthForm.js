  ...
  return (
    <div className="mx-auto my-12 max-w-md">
      <form onSubmit={handleSubmit} className="shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <h1 className="text-3xl text-center text-blue-500 font-semibold mb-4">{formType === 'login' ? 'Login' : 'Sign up'} to Remindere</h1>
        ...
        <button
          type="submit"
          className="px-4 font-bold py-2 text-gray-800 rounded-lg bg-blue-500 hover:bg-white transition"
        >
